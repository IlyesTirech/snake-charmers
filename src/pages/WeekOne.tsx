  ...
  return (
    <>
      ...
      <Group justify="space-between" mt="md" mb="xs">
        ...
        <Input placeholder="Input component" onChange={handleTask1} value={num}/>
      <h1>{w1t1()}</h1>
      </Group>
    </Card>
    <Card shadow="sm" padding="lg" radius="md" withBorder>
    ...
    <Card shadow="sm" padding="lg" radius="md" withBorder>
      <Group justify="space-between" mt="md" mb="xs">
        ...
        <Input placeholder="Input component" onChange={handleTask3a} value={numArray.join(',')}/>
      <h1>{w1t3a()}</h1>
      <Text fw={500}>Task 3b</Text>
      <h1>{w1t3b()}</h1>
      <Text fw={500}>Task 3c</Text>
      <Input placeholder="Input component" onChange={handleTask3b} value={twoDArr.join(',')}/>
      <h1>{w1t3c()}</h1>
      </Group>
    </Card>
