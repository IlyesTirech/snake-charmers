...
const Cards = () => {
  ...
  return (
    <Container my="md">
      <Grid>
        <Grid.Col span={{ base: 12, xs: 4 }}> <Card shadow="sm" padding="lg" radius="md" withBorder>
      ...
      <Button variant="light" color="blue" fullWidth mt="md" radius="md" onClick={onClickWeek1}>
